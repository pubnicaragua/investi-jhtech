-- ============================================================================
-- FIX: Verificar user_follows y crear función correcta
-- ============================================================================

-- PASO 1: Verificar estructura de user_follows
SELECT 
  column_name, 
  data_type
...
-- PASO 3: Crear función con columnas correctas
-- Nota: user_follows puede tener: follower_id/following_id O follower_id/followed_id
...
BEGIN
  ...
  WITH candidate_users AS (
    ...
    WHERE u.id != p_user_id
      ...
      -- CAMBIO: Usar following_id en lugar de followed_id
      AND NOT EXISTS (
        SELECT 1 
...
-- PASO 4: Verificar
SELECT 'Función creada con following_id' as status;
