-- SISTEMA DE SOPORTE Y REPORTE DE BUGS - BACKEND SUPABASE
...
-- 5. POLÍTICAS DE SEGURIDAD - TICKETS
...
-- Usuarios pueden actualizar sus propios tickets (solo ciertos campos)
CREATE POLICY "Users can update own tickets" ON support_tickets
  FOR UPDATE USING (auth.uid() = user_id)
  WITH CHECK (auth.uid() = user_id);

-- 6. POLÍTICAS DE SEGURIDAD - ADJUNTOS
...
-- 10. FUNCIÓN PARA REGISTRAR CAMBIOS EN HISTORIAL
...
-- 11. TRIGGER PARA REGISTRAR CAMBIOS
...
-- 12. CREAR BUCKET DE ALMACENAMIENTO PARA ADJUNTOS
-- Ejecutar en Storage > Buckets
-- Nombre: support_attachments
-- Privado: No (para permitir descargas)

-- 13. POLÍTICAS DE STORAGE
-- Para el bucket support_attachments:
...
-- 14. FUNCIÓN PARA OBTENER ÚLTIMOS 10 ERRORES
...
-- 15. FUNCIÓN PARA OBTENER TICKETS POR USUARIO
...
-- 16. FUNCIÓN PARA OBTENER ESTADÍSTICAS DE TICKETS
...
-- ============================================================================
-- 1. Copiar y ejecutar este script en SQL Editor de Supabase
-- 2. Crear bucket "support_attachments" en Storage
-- 3. Configurar políticas de Storage:
--    - SELECT: (auth.uid() != null)
--    - INSERT: (auth.uid() != null)
--    - DELETE: (auth.uid() = owner_id) -- requiere que el archivo tenga owner_id
-- 4. Agregar la pantalla SupportTicketScreen al navigation
-- 5. Crear la ruta en el navigation stack
-- ============================================================================
